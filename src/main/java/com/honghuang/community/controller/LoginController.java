...
//        session.setAttribute("kaptcha",text);
        ...
        //给以owner作为的key放入验证码text,并设置过期时间60s
    ...
    public String login(String username,String password,String code,boolean rememberme,
                        Model model/*,HttpSession session*/,@CookieValue("kaptchaOwner") String kaptchaOwner,  //接收key为kaptchaOwner的cookie
                        HttpServletResponse response){//当获取参数不是对象实体时,需要手动装载参数进model中
        //判断验证码正确性
